...
AUDIO_CHIPSET := audio
# Build/Package only in case of supported targetq
ifeq ($(call is-board-platform-in-list,msmnile $(MSMSTEPPE) $(TRINKET) kona lito bengal sdmshrike sdm660 sdm845 msm8953 msm8937),true)
